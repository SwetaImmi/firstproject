                            ...
                            <div class="hover-content">
                                <ul>
                                    ...
                                    <form action="{{route('wishlist.store')}}" id="contact_form" method="post">
                                            ...
                                            <input type="hidden" name="product_id" type="text" value="{{$products->id}}" />
                                            <button class="btn btn-default btn-lg btn-flat"><i class="fa fa-heart-o " style=" width: 50px; height: 50px;  background-color: #fff"></i></button>
                                        </form>
                                    </li>
